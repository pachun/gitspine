        ...
        match event::read().unwrap() {
            Event::Key(key) => {
                let action = match (key.code, key.modifiers) {
                    ...
                    (KeyCode::Char('j'), m) if m.contains(KeyModifiers::CONTROL) => Action::CtrlJ,
                    (KeyCode::Char('k'), m) if m.contains(KeyModifiers::CONTROL) => Action::CtrlK,
                    (KeyCode::Char('h'), m) if m.contains(KeyModifiers::CONTROL) => Action::CtrlH,
                    (KeyCode::Char('l'), m) if m.contains(KeyModifiers::CONTROL) => Action::CtrlL,
